        ...
        <div>
          ...
          <div className="border border-primaryGreen m-20 rounded-3xl flex items-center">
            ...
            <h4 className="bg-white">
              ...
              relationship with food. That's why I offer personalised nutrition
              plans{" "}
            </h4>

            <p className="pt-10 border border-slate-400 text-lg">
              ...
              their best lives through nutrition education, support, and
              encouragement.
            </p>
            </div>
